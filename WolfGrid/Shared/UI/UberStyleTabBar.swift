...
struct UberStyleTabBar: View {
    ...
    private enum Tab: Int, CaseIterable {
        case home = 0, record = 1, leads = 2, more = 3
    ...
    private let salespersonTabs: [SalespersonTab] = [
        ...
        SalespersonTab(id: 2, title: "WolfGrid", icon: "person.2", selectedIcon: "person.2.fill"),
        SalespersonTab(id: 3, title: "Messages", icon: "message", selectedIcon: "message.fill"),
