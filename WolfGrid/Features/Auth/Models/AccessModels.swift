...
struct AccessStateResponse: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        isAmbassador = try c.decodeIfPresent(Bool.self, forKey: .isAmbassador) ?? false
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encode(isFounder, forKey: .isFounder)
        try c.encode(isAmbassador, forKey: .isAmbassador)
...
struct LiveSessionCodeJoinResponse: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        accessScope = try c.decodeIfPresent(String.self, forKey: .accessScope)
            ?? c.decodeIfPresent(String.self, forKey: .accessScopeCamel)
        redirect = try c.decodeIfPresent(String.self, forKey: .redirect) ?? "dashboard"
    }
}
