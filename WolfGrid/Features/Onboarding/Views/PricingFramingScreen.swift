...
struct PricingFramingScreen: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                VStack(spacing: 8) {
                    Text("WolfGrid is free to try but very limited.")
                        .font(.system(size: 28, weight: .bold))
                        .multilineTextAlignment(.center)
                    Text("To get the most out of WolfGrid, we recommend PRO.")
                        .font(.system(size: 16))
                ...
                Text("What would you need from WolfGrid to make $30/month worth it?")
