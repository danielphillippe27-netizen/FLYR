...
private enum ChallengeShareComposer {
    ...
    static func activityItems(for challenge: Challenge, message: String, url: URL?) -> [Any] {
        ...
        let textSource = ChallengeShareTextSource(
            message: message,
            title: "\(challenge.title) • WolfGrid Challenge",
            url: url,
            previewImage: image
        )
            ...
            VStack(alignment: .leading, spacing: 28) {
                ...
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    Text(challenge.description?.isEmpty == false
                         ...
                         : "Open WolfGrid, accept the invite, and start tracking the competition.")
        ...
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    Text(challenge.description?.isEmpty == false
                         ? challenge.description!
                         : "Accept the challenge in WolfGrid and post your result.")
                        ...
                        HStack(spacing: 14) {
                            ...
                            VStack(alignment: .leading, spacing: 6) {
                                Text("accept the invitation")
                                    ...
                                    .foregroundStyle(Color.white)
                                Text("Open in WolfGrid to join the challenge")
