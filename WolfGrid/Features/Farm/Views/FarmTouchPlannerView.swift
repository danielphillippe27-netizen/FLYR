            ...
            Group {
                if viewModel.isLoading && viewModel.touches.isEmpty {
                    ...
                    ContentUnavailableView(
                        ...
                        description: Text("Touches created in WolfGrid Web will show up here, and you can also add or complete them from iOS.")
                    )
                    .padding(.top, 40)
                } else {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if touch.campaignId != nil, !touch.completed {
                ...
                Text("Attach a campaign to this touch in WolfGrid Web to run it from iOS.")
                    .font(.flyrCaption)
                    .foregroundStyle(.secondary)
            }
        }
