...
final class LiveSessionVoiceAPI {
    ...
    private let defaultVoiceAPIURL = "https://wolfgrid.app"
    ...
    private var baseURL: String {
        ...
        if let configuredInvitesURL = Bundle.main.object(forInfoDictionaryKey: "WOLFGRID_INVITES_API_URL") as? String,
