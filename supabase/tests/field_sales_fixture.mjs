...
`);
await db.exec(await readFile(new URL('../migrations/20260915190000_field_sales_v1.sql',import.meta.url),'utf8'));

await db.exec(await readFile(new URL('../migrations/20260915230000_field_sales_pipeline_beta.sql',import.meta.url),'utf8'));
await db.exec(await readFile(new URL('../migrations/20260915234000_field_sales_aggregate_precision.sql',import.meta.url),'utf8'));
return {db,id};
}
