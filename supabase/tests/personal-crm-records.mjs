...
CREATE TABLE sales_contacts(id uuid PRIMARY KEY,user_id uuid,owner_user_id uuid,workspace_id uuid,source text,external_id text,merged_into_id uuid);
...
INSERT INTO sales_contacts VALUES ('${a}','${a}',NULL,'${w}','source','same-external',NULL),('${b}','${b}',NULL,'${w}','source','same-external',NULL);
...
console.log('PASS: personal CRM ownership, same-prospect independence and cross-user merge/actor-spoof prevention.');
await db.close();
