...
-- Previous policies referenced each other:
--   workspaces SELECT -> workspace_members
--   workspace_members SELECT -> workspaces
...
-- or by ensuring owners have their own owner membership row.
