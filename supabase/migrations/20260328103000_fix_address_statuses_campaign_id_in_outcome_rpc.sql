-- Fix: address_statuses.campaign_id NOT NULL violations in outcome RPC
-- Some schemas have both campaign_address_id and campaign_id on address_statuses
-- with campaign_id enforced NOT NULL. Ensure record_campaign_address_outcome
-- always writes campaign_id when that column exists.
