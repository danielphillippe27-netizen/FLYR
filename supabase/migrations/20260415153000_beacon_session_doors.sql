...
'Returns the public Beacon payload for an active session, including live breadcrumbs, safety alerts, and the latest door outcomes recorded during that session.';
