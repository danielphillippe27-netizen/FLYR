-- Add optional brokerage to leaderboard RPC results.
-- Assumes realtor onboarding stores brokerage in auth user metadata.
...
COMMENT ON FUNCTION public.get_leaderboard(TEXT, TEXT, UUID) IS 'Leaderboard with optional workspace scope and optional brokerage from auth metadata.';
