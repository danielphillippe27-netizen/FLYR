    ...
    func testCSVFormat() throws {
        let addresses = [
            QRCodeAddress(
                ...
                webURL: "https://wolfgrid.app/address/test1",
                deepLinkURL: "wolfgrid://address/test1"
            ),
            QRCodeAddress(
                id: UUID(),
                addressId: UUID(),
                formatted: "153 Sprucewood Crescent",
                webURL: "https://wolfgrid.app/address/test2",
                deepLinkURL: "wolfgrid://address/test2"
            )
        ]
    ...
    func testCSVEscaping() throws {
        let addresses = [
            QRCodeAddress(
                ...
                webURL: "https://wolfgrid.app/address/test",
                deepLinkURL: "wolfgrid://address/test"
            )
        ]
    ...
    func testPNGCount() throws {
        let addresses = [
            ...
            QRCodeAddress(
                ...
                addressId: UUID(),
                formatted: "Address 3",
                webURL: "https://wolfgrid.app/address/test3",
                deepLinkURL: "wolfgrid://address/test3"
            )
        ]
    ...
    func testPDFGridPageCount() throws {
        ...
        let addresses = (1...15).map { index in
            QRCodeAddress(
                ...
                webURL: "https://wolfgrid.app/address/test\(index)",
                deepLinkURL: "wolfgrid://address/test\(index)"
            )
        }
