...
struct AddressStatusRow: Decodable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case lastClientMutationId = "last_client_mutation_id"
        case createdAt = "created_at"
        case updatedAt = "updated_at"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        sourceOccurredAt = try c.decodeIfPresent(Date.self, forKey: .sourceOccurredAt)
        lastClientMutationId = try c.decodeIfPresent(String.self, forKey: .lastClientMutationId)
