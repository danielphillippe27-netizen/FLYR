        ...
        VStack(alignment: .leading, spacing: 20) {
            if let email, !email.isEmpty {
                PasswordRecoveryNoticeCard(
                    ...
                    message: "Enter the new password you want to use for this WolfGrid account.",
                    accent: .info,
    ...
    private func submitPasswordReset() async {
        ...
        do {
            ...
            routeState.presentPasswordReset(
                state: .success(message: "Your password has been updated. Use it the next time you sign in to WolfGrid."),
