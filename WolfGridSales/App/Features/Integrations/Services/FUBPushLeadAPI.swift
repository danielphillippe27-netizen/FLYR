...
/// Calls WolfGrid backend POST /api/integrations/fub/push-lead and POST /api/leads/sync-crm with Bearer JWT.
...
final class FUBPushLeadAPI {
    ...
    func pushLead(
        ...
        let body = FUBPushLeadRequest(
            ...
            source: lead.source.isEmpty ? "WolfGrid" : lead.source,
            sourceUrl: nil,
    ...
    /// Send a test lead to Follow Up Boss (test@wolfgrid.app, 5555555555).
