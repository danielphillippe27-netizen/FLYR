...
enum IntegrationProvider: String, Codable, CaseIterable, Identifiable {
    ...
    case monday = "monday"
    case zapier = "zapier"
    case jobnimbus = "jobnimbus"
    case companycam = "companycam"
    case jobber = "jobber"
    case acculynx = "acculynx"
    case rooflink = "rooflink"
    ...
    var displayName: String {
        ...
        case .companycam: return "CompanyCam"
        case .jobber: return "Jobber"
        case .acculynx: return "AccuLynx"
        case .rooflink: return "RoofLink"
        }
    }
    ...
    var icon: String {
        ...
        case .jobnimbus, .acculynx, .rooflink: return "person.text.rectangle"
        case .companycam: return "camera.fill"
        case .jobber: return "briefcase.fill"
        }
    }
    ...
    var logoName: String {
        ...
        case .jobnimbus, .companycam, .jobber, .acculynx, .rooflink: return "WolfGridLogo"
        }
    }
    ...
    var description: String {
        ...
        case .jobnimbus: return "Create contacts or jobs in JobNimbus from WolfGrid leads"
        case .companycam: return "Create CompanyCam projects from WolfGrid lead addresses"
        case .jobber: return "Create Jobber clients from WolfGrid lead records"
        case .acculynx: return "Send WolfGrid leads into AccuLynx roofing workflows"
        case .rooflink: return "Create RoofLink jobs from WolfGrid lead records"
        }
    }
...
struct IntegrationCatalogProvider: Codable, Identifiable {
    let id: String
    let displayName: String
    let description: String?
    let authModes: [String]?
    let preferredAuthMode: String?
    let tokenLabel: String?
    let tokenPlaceholder: String?
    let connected: Bool

    var nativeProvider: IntegrationProvider? {
        switch id {
        case "followupboss": return .fub
        case "boldtrail": return .boldtrail
        default: return IntegrationProvider(rawValue: id)
        }
    }
}
