                ...
                if isLoading {
                    ...
                    ScrollView {
                        VStack(spacing: 20) {
                            ...
                            Section {
                                VStack(spacing: 12) {
                                    ForEach(catalogProviders.compactMap(\.nativeProvider), id: \.id) { provider in
                                        ...
                                        IntegrationCardView(
                                            ...
                                            connectedOverride: catalogProviders.first { $0.nativeProvider == provider }?.connected,
                                ...
                                Section {
                                    VStack(alignment: .leading, spacing: 12) {
                                        Text(mondayIntegration.mondayNeedsBoardSelection
                                             ? "Monday.com is connected, but WolfGrid still needs a board before sync can run."
                                             : "WolfGrid will sync leads to \(mondayIntegration.selectedBoardName ?? "your selected monday board").")
                                            .font(.system(size: 14))
