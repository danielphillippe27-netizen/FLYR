...
struct RoutePreviewView: View {
    ...
    var body: some View {
        ...
        .alert("Allow Location Access", isPresented: $showLocationPermissionAlert) {
            ...
            Text("WolfGrid uses your location only during an active session. Allow location access to start this route and track progress.")
        }
    ...
    private var backgroundTrackingCard: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("After you start, WolfGrid can continue your route and session progress in the background if you choose that option for this active session.")
                .font(.flyrCaption)
                .foregroundColor(.secondary)
