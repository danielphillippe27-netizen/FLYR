...
export async function listPendingWorkspaceInvites(
  ...
  if (!minimalInviteQuery.error) {
    return {
      data: normalizeInviteRecords(minimalInviteQuery.data as unknown as Record<string, unknown>[] | null),
      error: null,
    };
  }
...
export async function findPendingWorkspaceInviteByEmail(
  ...
  if (!isMissingLastSentAtColumnError(withLastSentAt.error)) {
    return {
      data: normalizeInviteRecord(withLastSentAt.data as unknown as Record<string, unknown> | null),
  ...
  return {
    data: normalizeInviteRecord(withoutLastSentAt.data as unknown as Record<string, unknown> | null),
...
export async function getWorkspaceInviteRecord(
  ...
  if (isMissingAccessScopeColumnError(withoutLastSentAt.error)) {
    ...
    return {
      data: normalizeInviteRecord(legacyWithoutScope.data as unknown as Record<string, unknown> | null),
