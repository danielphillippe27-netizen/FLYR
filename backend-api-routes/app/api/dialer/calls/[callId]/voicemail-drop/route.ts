...
async function getPersonalVoicemailDrop(
  ...
  return data ? signPersonalVoicemailDrop(admin, data as DialerVoicemailDrop, workspaceId, userId) : null;
}
...
export async function POST(
  ...
  try {
    const voicemailDrop = await getPersonalVoicemailDrop(context.admin, context.workspaceId, context.requestUser.id, body.voicemailDropId);
    if (!voicemailDrop) {
