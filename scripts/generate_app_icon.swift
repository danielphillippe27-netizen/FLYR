...
let appIconDir = projectRoot.appendingPathComponent("FLYR/Assets.xcassets/AppIcon.appiconset")

guard let icon = AppIconGenerator.generate() else {
...
let outputURL = appIconDir.appendingPathComponent("AppIcon-1024.png")
do {
